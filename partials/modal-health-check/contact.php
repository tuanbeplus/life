    ...
    <div class="inner">
        ...
        <form id="health-check-contact" action="/" method="post" class="screening-email"
            ...
            <div class="columned-group">
                <div class="column">
                    <div class="form-group">
                        ...
                        <input id="send-contact-first-name" type="text" name="first_name" required/>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="form-group">
                        ...
                        <input id="send-contact-last-name" type="text" name="last_name" required/>
                    </div>
                </div>
            </div>
            ...
            <div class="columned-group">
                <div class="column">
                    <div class="form-group">
                        ...
                        <input id="send-contact-email" type="email" name="email" required/>
                    </div>
                </div>
                <div class="column">
                    <div class="form-group">
            ...
            <div class="columned-group">
                <div class="column">
                    <div class="form-group">
                        ...
                        <input id="send-contact-postcode" type="text" name="postcode" required/>
                    </div>
                </div>
                <div class="column">
                    <div class="form-group">
                        ...
                        <select id="send-contact-via" name="heard_about_via">
                            ...
                            <option value="Advertising campaign April/May 2024">Advertising campaign April/May 2024</option>
                            <option value="A friend or family member">A friend or family member</option>
                            <?php if (FIT_BIT_COMPETITION): ?>
                                <option value="Fitbit Competition">Fitbit Competition</option>
                            <?php endif ?>
            ...
            <div class="form-group close-modal">
                <button type="button" name="submit_signup" class="button grey" data-refresh-page
                        aria-label="Return to site"><span>Return to Site</span></button>
            </div>

            <div class="form-group submit tracking-contact-submit-en">
                <button
                    type="submit"
                    name="send_enquiry"
